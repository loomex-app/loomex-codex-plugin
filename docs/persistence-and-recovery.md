...
Persisted state includes navigation, pagination, setup values, answer position and review phase. Backend answer drafts are bound to the exact human request and its schema digest. Changing an answer-defining question invalidates stale drafts. A saved draft is not a submitted answer.
