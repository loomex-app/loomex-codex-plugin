...
Read [the visual delivery contract](../loomex-workflows/references/visual-delivery.md) for payload preservation, rendering evidence and headless result delivery.
